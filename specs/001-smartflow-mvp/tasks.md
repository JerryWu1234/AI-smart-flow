# Tasks: SmartFlow 4.0 Pi Worker Migration

**Input**: `spec.md`, `plan.md`, `research.md`, `data-model.md`, `contracts/`  
**Scope**: Replace OpenCode and custom Broker with sandboxed `@earendil-works/pi-coding-agent`; preserve isolated Workspace, Review and Publish.  
**Task IDs**: Continue after completed SmartFlow 3.0 baseline T109–T140.
